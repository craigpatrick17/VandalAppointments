...
//Rare exceptions to indicate a bug in the _comvandalappointmentsprototype code (Eg, function that a subclass should have implemented)
...
/**
 The base class for comvandalappointmentsprototype proxies.
 */
