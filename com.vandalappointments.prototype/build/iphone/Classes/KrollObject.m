...
//@interface comvandalappointmentsprototypeObject : NSObject
//@end

@interface comvandalappointmentsprototypeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[comvandalappointmentsprototypeObject class]])
		{
			for (NSString *key in [[(comvandalappointmentsprototypeObject*)o modules] allKeys])
			{
