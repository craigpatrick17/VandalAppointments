 ...
 * to send analytic data that can be viewed on the comvandalappointmentsprototype Dashboard.
 *
 * For information on getting started with comvandalappointmentsprototype Platform Services,
