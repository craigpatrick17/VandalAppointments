...
/**
 Base class for all comvandalappointmentsprototype views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the comvandalappointmentsprototype view hierarchy (such as wrapped iOS UIViews) was touched.
