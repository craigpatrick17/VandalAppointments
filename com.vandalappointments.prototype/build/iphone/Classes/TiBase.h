...
// in simulator we redefine to format for comvandalappointmentsprototype Developer console
...
{\
	NSString * exceptionName = [@"org.comvandalappointmentsprototype." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.comvandalappointmentsprototype";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIcomvandalappointmentsprototypeNativeItemNone = -1, 
	UIcomvandalappointmentsprototypeNativeItemSpinner = -2,
	UIcomvandalappointmentsprototypeNativeItemProgressBar = -3,
	
	UIcomvandalappointmentsprototypeNativeItemSlider = -4,
	UIcomvandalappointmentsprototypeNativeItemSwitch = -5,
	UIcomvandalappointmentsprototypeNativeItemMultiButton = -6,
	UIcomvandalappointmentsprototypeNativeItemSegmented = -7,
	
	UIcomvandalappointmentsprototypeNativeItemTextView = -8,
	UIcomvandalappointmentsprototypeNativeItemTextField = -9,
	UIcomvandalappointmentsprototypeNativeItemSearchBar = -10,
	
	UIcomvandalappointmentsprototypeNativeItemPicker = -11,
	UIcomvandalappointmentsprototypeNativeItemDatePicker = -12,
	
	UIcomvandalappointmentsprototypeNativeItemInfoLight = -13,
	UIcomvandalappointmentsprototypeNativeItemInfoDark = -14,
	
	UIcomvandalappointmentsprototypeNativeItemDisclosure = -15,
	
	UIcomvandalappointmentsprototypeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all comvandalappointmentsprototype instances of
