...
@interface comvandalappointmentsprototypeObject : KrollCoverageObject {
#else
@interface comvandalappointmentsprototypeObject : KrollObject {
#endif
@private
...
extern NSString * comvandalappointmentsprototype$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	comvandalappointmentsprototypeObject *_comvandalappointmentsprototype;
    KrollObject* console;
	BOOL shutdown;
