...
/**
 The base class for all comvandalappointmentsprototype modules
 */
...
/**
 comvandalappointmentsprototype Platform calls this method on startup.
 */
-(void)startup;

/**
 comvandalappointmentsprototype Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 comvandalappointmentsprototype Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 comvandalappointmentsprototype Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 comvandalappointmentsprototype Platform calls this method on resume.
 @param sender The sender of the event.
 */
